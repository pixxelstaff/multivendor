          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class=" mb-0 text-uppercase p-f16">Today's Money</p>
                    <h5 class="p-f14 my-1">
                      $53,000 - <?= $logged_actual_city_name ?>
                    </h5>
                    <p class="mb-0 p-f14">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="mb-0 text-uppercase p-f16">Today's Users</p>
                    <h5 class="p-f14 my-1">
                      2,300 -  <?= $logged_actual_country_name ?>
                    </h5>
                    <p class="mb-0 p-f14">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="mb-0 text-uppercase p-f16">New Clients</p>
                    <h5 class="p-f14 my-1">
                      +3,462
                    </h5>
                    <p class="mb-0 p-f14">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="mb-0 text-uppercase p-f16">Sales</p>
                    <h5 class="p-f14 my-1">
                      $103,430
                    </h5>
                    <p class="mb-0 p-f14">
