                ...
                <div class="vendor-tabs-div col-12 mt-4">
                    <div class="w-100 d-flex field-parent">
                        <div class="field-box">
                            ...
                            <input type="text" value="<?= $v__user__name ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">Surname</label>
                            <input type="text" value="<?= $v__user__surname ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">Email</label>
                            <input type="text" value="<?= $v__user__email ?>" disabled>
                        </div>
                    ...
                    <div class="w-100 d-flex field-parent">
                        <div class="field-box">
                            ...
                            <input type="text" value="<?= $v__user__phone ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">CNIC</label>
                            <input type="text" value="<?= $v__user__cnic ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">Business</label>
                            <input type="text" value="<?= $v__user__business ?>" disabled>
                        </div>
                    ...
                    <div class="w-100 d-flex field-parent">
                        <div class="field-box">
                            ...
                            <input type="text" value="<?= $v__user__businessurl ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">Country</label>
                            <input type="text" value="<?= $logged_actual_country_name ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">City</label>
                            <input type="text" value="<?= $logged_actual_city_name ?>" disabled>
                        </div>
                    </div>
                    <div class="w-100 d-flex field-parent">
                        <div class="field-box">
                            <label for="">Zipcode</label>
                            <input type="text" value="<?= $v__user__zipcode ?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">country-code</label>
                            <input type="text" value="<?= $v__user__country_code?>" disabled>
                        </div>
                        <div class="field-box">
                            <label for="">Address</label>
                            <input type="text" value="<?= $v__user__address ?>" disabled>
                        </div>
                    ...
                    <div class="w-100 d-flex field-parent">
                        ...
                        <div class="field-box">
                            ...
                            <input type="text" value="276" disabled>
                        </div>
                        <div class="field-box">
