	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12 ">
				...
				<di class="user-display-flex">

					<a href="user-reg.php" class="text-decoration-none text-dark user-popup">

						<img src="assets/bootstrap/img/user-icon1.webp">

						<p>Are you Join as a</p>

						<h3>User</h3>

					</a>

					<a href="vendor-reg.php" class="text-decoration-none text-dark user-popup icon-down">

						<img src="assets/bootstrap/img/user-icon2.webp">
			...
			<!-- <div class="user-button-next">

				<button>Next</button>

				<p>All ready a user ? <a href="/vendor/login.php">Sign in</a></p>
