...
<body>
    <table style='width:100%;background:#fff;padding:0px;max-width:600px;border:1px solid #eee;margin:0px auto;' cellspacing='0'>
        <tbody>
            <tr>
        ...
        <tbody>
            ...
            <td class='width:100%;padding:10px;'>
                <table style='max-width: 450px;margin:10px auto;'>
                    <tbody>
                        <tr>
                            <td style='width: 100%;text-align:left;padding:10px;vertical-align:middle;font-size:18px;font-weight:600;font-family: Outfit, sans-serif;'>
                                Dear [Customer's Name],
                            </td>
                        </tr>
                        <tr>
                            <td style='width: 100%;text-align:left;padding:10px;vertical-align:middle;font-size:14px;font-weight:600;font-family: Outfit, sans-serif;'>
        ...
        <tbody>
            <td class='width:100%;padding:0px;'>
                <table style='max-width: 450px;margin:10px auto;'>
                    <tbody>
                        <tr>
                            <td style='width: 100%;text-align:left;padding:10px 0px;vertical-align:middle;font-size:14px;font-weight:600;font-family: Outfit, sans-serif;'>
