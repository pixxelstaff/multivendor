...
<body class="g-sidenav-show   bg-gray-100">
                    ...
                    <div class="row p-2">
                        <div class="col-lg-9 col-md-12 col-sm-12 data-column">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 p-inp-div d-flex flex-column p-2">
                                    ...
                                    <select name="product-category" id="" class="p-inp-field w-100">
                                        ...
                                        while ($sh = mysqli_fetch_assoc($opt)) {
                                            echo "<option value =" . $sh['Id'] . ">" . str_replace("\\", "", $sh['name']) . "</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-12 p-2" id="var-parent">
                                <!-- <div class="variation-wrapper col-12 p-0" id="variation-1">
                                    <div class="variation-head col-12" data-id="var-div-1">
                                        <span class="variation-head-name">
                                            variation-01
                                        </span>
                                        <div class="d-flex align-items-center gap-1">
                                            <a href="javascript:void(0)" class="remove-variation text-white" data-var-id='variation-1'>remove</a>
                                            <span class="material-symbols-outlined attr-direction">
                                                expand_more
                                            </span>
                                        </div>
                                    </div>
                                    <div class="variable-product-field-div col-12" id="var-div-1">
                                        <div class="col-12 d-flex flex-wrap">
                                            <div class="col-lg-6 col-md-6 col-sm-12  p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">price</label>
                                                <input type="text" name="" class="p-inp-field" placeholder="regular price" id="">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12  p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">sale price</label>
                                                <input type="text" name="" class="p-inp-field" placeholder="sale price" id="">
                                            </div>
                                        </div>
                                        <div class="col-12 d-flex flex-wrap">
                                            <div class="col-lg-4 p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">length</label>
                                                <input type="text" name="" id="" placeholder="in cm" class="p-inp-field">
                                            </div>
                                            <div class="col-lg-4 p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">width</label>
                                                <input type="text" name="" id="" placeholder="in cm" class="p-inp-field">
                                        ...
                                        <div class="col-12 d-flex flex-wrap">
                                            <div class="col-4 p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">Quantity</label>
                                                <input type="text" name="" class="p-inp-field" placeholder="Quantity" id="">
                                            </div>
                                            <div class="col-4 p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">Sku (optional)</label>
                                                <input type="text" name="" class="p-inp-field" placeholder="ege-0986" id="">
                                            </div>
                                            <div class="col-4 p-inp-div d-flex flex-column p-2">
                                                <label for="" class="p-inp-label">stock</label>
                                                <select name="" id="" class="p-inp-field">
                                                    <option value="1">In stock</option>
                                                    <option value="0">Out of stock</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-12 p-inp-div d-flex flex-column p-2">
                                            ...
                                            <textarea id="des-editor" class="w-100 p-inp-field" rows="6"></textarea>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
    ...
    <div class="success-wrapper">
            ...
            <div class="d-flex justify-content-center mb-0"><a href="product.php" class="approve-btn px-4 mb-3">ok</a></div>
...
?>
                                <script>
                                    window.location.href = '?screen=<?= base64_encode('success') ?>&msg= <?= base64_encode('the product is inert with id ' . $insertId . ' and attribute are also saved and variation are also saved.once the admin approved the product it is show on your products page and will ready to start sells') ?>';
                                </script>
                            <?php
                            }
                        }
                        //variation if starts here
                            ...
                            ?>
                            <script>
                                window.location.href = '?screen=<?= base64_encode('success') ?>&msg=<?= base64_encode('the product is inert with id ' . $insertId . ' and attribute are also saved.once the admin approved the product it is show on your products page and will ready to start sells') ?>';
                            </script>
                    <?php
                        }
                ...
                //checking attribute if ends here
                    ...
                    ?>
                    <script>
                        window.location.href = '?screen=<?= base64_encode('success') ?>&msg=<?= base64_encode('the product is insert with id ' . $insertId . 'once the admin approved the product it is show on your products page and will ready to start sells') ?>';
                    </script>
        <?php
                }
