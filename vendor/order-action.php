...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        $count_qry = fetchOtherdetails($con, 'order_items', 'item_vendor_id', $v__user__id);
                ...
                <div class="col-12 table-responsive product-wrapper">
                    <table class=" product-table w-100">
                        ...
                        <tbody>
                            ...
                            $order_items = mysqli_prepare($con, "SELECT * FROM `order_items` WHERE `item_vendor_id` = ? ORDER BY `Id` DESC LIMIT $limit OFFSET $offset");

                            mysqli_stmt_bind_param($order_items, 's', $v__user__id);
                            ...
                            ?>
                                        <tr>
                                            <td><input type="checkbox" value="<?= $sh_order_items['Id'] ?>" name="" id=""></td>
                                            <td><?= $sno ?></td>
                                            <td><?= $ord['purchase_code']  ?></td>
                                            <td><?= $ord['name']  ?> <?= $ord['lastname'] ?></td>
