            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 login-form-wrapper d-flex align-items-center justify-content-center">
                    ...
                    <div class="login-form-box col-12">
                        ...
                        <form class="form w-100" action="" method="post" id="shah">



                            <h2 class="log-head">Sign in - Vendor dashboard</h2>
                            ...
                            <div class="flex-row">
                                ...
                                <a href="forget.php" class="span">Forgot password?</a>
                            ...
                            <p class="p">Don't have an account? <a href="/vendor-reg.php" class="span">Sign Up</a> </p>
...
<?php
                ...
                alerting('data not found, incorrect email', 'login.php');
            }
        } else {
