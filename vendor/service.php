...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        $offset = ($page - 1) * $limit;
        $count_qry  = fetchOtherdetails($con, 'service', 'user_id', $v__user__id);
        ...
        <div class="container-fluid p-4">
            <div class="col-12 p-2 rounded bg-white">
                ...
                <?php
                $showservice = "SELECT * FROM `service` WHERE `user_id` = ? ORDER BY `Id` DESC LIMIT $limit OFFSET $offset";
                $showservice__prepare = mysqli_prepare($con, $showservice);
                mysqli_stmt_bind_param($showservice__prepare, 's', $v__user__id);
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                if ($sh['category'] != '') {
                                                    $fetch_category = fetchOtherdetails($con, 'service_category', 'Id', $sh['category']);
                                            ...
                                            <td>
                                                    ...
                                                    ?>
                                                     <div class="action-button-div">
                                                        <a href="../service.php?id=<?= base64_encode($sh['Id']) ?>" class="eye-btn">
                                                            <span class="material-symbols-outlined ">
                                                                visibility
                                                            </span>
                                                        </a>
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                        <a href="javascript:void(0)" class="approve-btn bg-danger">unapproved</a>
                                                        <?php
                                                    }
                                                    ?>
